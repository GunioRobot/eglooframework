<?php
/**
 * RequestInfoException Class File
 *
 * Contains the class definition for the RequestInfoException.
 * 
 ...
 * @subpackage Exceptions
 */
final class RequestInfoException extends Exception {

   /**
    * RequestInfoException constructor.  Takes a message and a code and invokes
    ...
    * @returns          an RequestInfoException
    */
