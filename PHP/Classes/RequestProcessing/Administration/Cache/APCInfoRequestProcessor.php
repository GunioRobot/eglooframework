<?php
/**
 * APCInfoRequestProcessor Class File
 *
 * Contains the class definition for the APCInfoRequestProcessor
 * 
 ...
 * @subpackage $subpackage
 */
class APCInfoRequestProcessor extends RequestProcessor {
	...
	public function processRequest() {
		...
		include eGlooConfiguration::getFrameworkRootPath() . '/Library/APC/apc.php';
