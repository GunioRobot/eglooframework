<?php
/**
 * SearchPeopleBaseRequestProcessor Class File
 *
...
/**
 * SearchPeopleBaseRequestProcessor
 * 
 * Needs to be commented
 * 
 * @package RequestProcessing
 ...
 */
class SearchPeopleBaseRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
		...
		//get a specific blog        	
        $daoFunction = 'getSearchProfiles';
		$inputValues = array();
 	    $inputValues[ 'name' ] = $searchParam;
		...
		//TODO: do we need this for right now? can we simplify for this release?
        $searchResults['People']['ResultCount'] = count( $gqDTOArray );
        $searchResults['People']['Results'] = array( $gqDTOArray );
