<?php
/**
 * ExternalMainPageJoinRequestProcessor Class File
 *
 * Contains the class definition for the ExternalMainPageJoinRequestProcessor, a
...
/**
 * External Main Page Join Form Request Processor
 * 
 * Handles client requests to retrieve the "Join eGloo" form linked from the
 * external main page.
 * 
 * @package RequestProcessing
 * @subpackage RequestProcessors
 */
class ExternalMainPageJoinRequestProcessor extends RequestProcessor {
