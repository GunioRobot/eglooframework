 ...
 */
class PermittedRolesSimpleACLDecorator extends SimpleACLDecorator {
    ...
    */
	protected function requestPreProcessing() {
		...
		$retVal = $this->__checkPermittedRoles();
    ...
    */
	...
	protected function __checkPermittedRoles() {
		$retVal = false;

		if (isset($_SESSION['egACLRole']) && in_array($_SESSION['egACLRole'], $this->_permittedRoles)) {
			$retVal = true;
		}
