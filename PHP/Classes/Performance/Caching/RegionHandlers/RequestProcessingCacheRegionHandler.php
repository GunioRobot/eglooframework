...
class RequestProcessingCacheRegionHandler extends CacheRegionHandler {
	...
	public function getObject( $key, $namespace = 'RequestProcessing', $keep_hot = false ) {
		$retVal = null;
	...
	public function storeObject( $key, $value, $namespace = 'RequestProcessing', $ttl = 0, $keep_hot = false ) {
		$retVal = null;
	...
	public function deleteObject( $key, $namespace = 'RequestProcessing', $kept_hot = false ) {
		$retVal = null;
