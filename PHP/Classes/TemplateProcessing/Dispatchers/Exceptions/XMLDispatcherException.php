<?php
/**
 * XMLDispatcherException Class File
 *
 * Contains the class definition for the XMLDispatcherException
 * 
...
/**
 * Exception subclass for use by XMLDispatcher
 */
final class XMLDispatcherException extends Exception {

   /**
    * XMLDispatcherException constructor.  Takes a message and a code and invokes
    ...
    * @returns          a XMLDispatcherException
    */
