<?php
/**
 * XHTMLDispatcherException Class File
 *
 * Contains the class definition for the XHTMLDispatcherException
 * 
...
/**
 * Private exception subclass for use by XHTMLDispatcher
 */
final class XHTMLDispatcherException extends TemplateDispatcherException {

   /**
    * XHTMLDispatcherException constructor.  Takes a message and a code and invokes
    ...
    * @returns          a XHTMLDispatcherException
    */
