...
class JavascriptDispatcher extends TemplateDispatcher {
    ...
    public static function getInstance( $application, $interfaceBundle ) {
        if ( !isset(self::$singletonDispatcher) ) {
            ...
            if ( (self::$singletonDispatcher = $cacheGateway->getObject(  eGlooConfiguration::getUniqueInstanceIdentifier() . '::' . 'JavascriptDispatcherNodes', 'ContentDispatching' ) ) == null ) {
                ...
                $cacheGateway->storeObject( eGlooConfiguration::getUniqueInstanceIdentifier() . '::' . 'JavascriptDispatcherNodes', self::$singletonDispatcher, 'ContentDispatching' );
            } else {
