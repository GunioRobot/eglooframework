...
class StyleSheetDispatcher extends TemplateDispatcher {
    ...
    public static function getInstance( $application, $interfaceBundle ) {
        if ( !isset(self::$singletonDispatcher) ) {
            ...
            if ( (self::$singletonDispatcher = $cacheGateway->getObject( eGlooConfiguration::getUniqueInstanceIdentifier() . '::' . 'StyleSheetDispatcherNodes', 'ContentDispatching' ) ) == null ) {
                ...
                $cacheGateway->storeObject( eGlooConfiguration::getUniqueInstanceIdentifier() . '::' . 'StyleSheetDispatcherNodes', self::$singletonDispatcher, 'ContentDispatching' );
            } else {
