<?php
/**
 * DefaultTemplateEngineException Class File
 *
 * Contains the class definition for the DefaultTemplateEngineException
 * 
...
/**
 * DefaultTemplateEngineException
 *
 ...
 * @subpackage $subpackage
 */
class DefaultTemplateEngineException extends TemplateEngineException {

   /**
    * DefaultTemplateEngineException constructor.  Takes a message and a code and invokes
    ...
    * @returns          a DefaultTemplateEngineException
    */
