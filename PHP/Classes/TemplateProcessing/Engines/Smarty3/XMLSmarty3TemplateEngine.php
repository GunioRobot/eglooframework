<?php
/**
 * XMLSmarty3TemplateEngine Class File
 *
 ...
 * @subpackage $subpackage
 */
class XMLSmarty3TemplateEngine extends Smarty3TemplateEngine implements TemplateEngineInterface {
