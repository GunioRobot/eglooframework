<?php
/**
 * XMLSmarty2TemplateEngine Class File
 *
 ...
 * @subpackage $subpackage
 */
class XMLSmarty2TemplateEngine extends Smarty2TemplateEngine implements TemplateEngineInterface {
