<?php
/**
 * CSSSmarty2TemplateEngine Class File
 *
 ...
 * @subpackage $subpackage
 */
class CSSSmarty2TemplateEngine extends Smarty2TemplateEngine implements TemplateEngineInterface {
