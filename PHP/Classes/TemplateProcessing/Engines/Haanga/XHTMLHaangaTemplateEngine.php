<?php
/**
 * XHTMLHaangaTemplateEngine Class File
 *
 ...
 * @subpackage TemplateEngines
 */
class XHTMLHaangaTemplateEngine extends HaangaTemplateEngine implements TemplateEngineInterface {
