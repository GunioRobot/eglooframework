<?php
/**
 * TemplateDispatcherException Class File
 *
 * Contains the class definition for the TemplateDispatcherException
 * 
...
/**
 * Exception subclass for use by TemplateDispatcher
 */
class TemplateDispatcherException extends Exception {

   /**
	* TemplateDispatcherException constructor.	Takes a message and a code and invokes
	...
	* @returns			a TemplateDispatcherException
	*/
