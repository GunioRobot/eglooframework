<?php
/**
 * CSSBuilderException Class File
 *
 * Contains the class definition for the CSSBuilderException
 *
 ...
 * CSSBuilderException
 *
 * Exception subclass for use by CSSBuilder
 *
 * $long_description
 *
 * @package $package
 * @subpackage $subpackage
 */
class CSSBuilderException extends Exception {
