<?php
/**
 * JavascriptBuilderException Class File
 *
 * Contains the class definition for the JavascriptBuilderException
 *
...
/**
 * JavascriptBuilderException
 *
 * Exception subclass for use by JavascriptBuilder
 *
 * $long_description
 *
 * @package $package
 * @subpackage $subpackage
 */
class JavascriptBuilderException extends Exception {
