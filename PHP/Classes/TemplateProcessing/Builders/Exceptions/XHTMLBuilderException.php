<?php
/**
 * XHTMLBuilderException Class File
 *
 * Contains the class definition for the XHTMLBuilderException
 * 
...
/**
 * XHTMLBuilderException
 *
 * Exception subclass for use by XHTMLBuilder
 *
 * $long_description
 *
 * @package $package
 * @subpackage $subpackage
 */
class XHTMLBuilderException extends Exception {
