<?php
/**
 * QueryExecutionRoutineManager Class File
 *
 ...
 * @subpackage $subpackage
 */
class QueryExecutionRoutineManager {

	public static function getQueryExecutionRoutine( QueryTransaction $queryTransaction ) {
		...
		if ( $queryTransaction->getQueryDialect() === DialectLibrary::MYSQL ) {
			...
			$retVal = new MySQLiOOPQueryExecutionRoutine();
		}
