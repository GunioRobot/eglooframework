<?php
/**
 * MySQLiOOPQueryResponseTransactionTransformRoutine Class File
 *
...
/**
 * MySQLiOOPQueryResponseTransactionTransformRoutine
 *
 * $short_description
 *
 * $long_description
 ...
 * @subpackage $subpackage
 */
class MySQLiOOPQueryResponseTransactionTransformRoutine extends QueryResponseTransactionTransformRoutine {
	...
	public function getSingleColumnFeederStringFormat( $queryResponseTransaction ) {
		...
		if (isset($dataPackage[0]) && count($dataPackage[0])) {
			...
			throw new Exception( 'MySQLiOOPQueryResponseTransactionTransformRoutine: Invalid column data set supplied' );
		}
