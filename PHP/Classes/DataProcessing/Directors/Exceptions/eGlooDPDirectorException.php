<?php
/**
 * eGlooDPDirectorException Class File
 *
 * Contains the class definition for the eGlooDPDirectorException
 * 
 ...
 * @subpackage $subpackage
 */
class eGlooDPDirectorException extends Exception {

   /**
    * eGlooDPDirectorException constructor.  Takes a message and a code and invokes
    ...
    * @returns          a eGlooDPDirectorException
    */
