<?php
/**
 * eGlooRequestDefinitionParserException Class File
 *
 * Contains the class definition for the eGlooRequestDefinitionParserException.
 * 
...
/**
 * eGlooRequestDefinitionParserException
 * 
 ...
 * @subpackage Exceptions
 */
final class eGlooRequestDefinitionParserException extends Exception {

   /**
    * eGlooRequestDefinitionParserException constructor.  Takes a message and a code and invokes
    ...
    * @returns          an eGlooRequestDefinitionParserException
    */
