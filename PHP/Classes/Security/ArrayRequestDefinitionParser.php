<?php
/**
 * ArrayRequestDefinitionParser Class File
 *
 ...
 * @subpackage Security
 */
final class ArrayRequestDefinitionParser extends eGlooRequestDefinitionParser {
	...
	private function loadRequestNodes(){
        eGlooLogger::writeLog( eGlooLogger::DEBUG, "ArrayRequestDefinitionParser: Processing XML", 'Security' );
		...
		eGlooLogger::writeLog( eGlooLogger::DEBUG, "ArrayRequestDefinitionParser: Loading "
    ...
    public static function getInstance( $webapp = "Default", $uibundle = "Default" ) {
        ...
        return self::$singletonArrayRequestDefinitionParser;
    }
