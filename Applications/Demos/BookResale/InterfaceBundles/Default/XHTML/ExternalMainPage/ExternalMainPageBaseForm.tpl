...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <title>eGloo | Book Owners Demo Service</title>
...
*}-->
    ...
    <body>
		<!-- <!--{$app}--> <!--{$bundle}--> -->
		Welcome to the eGloo Book Resale Demo Service<br />
		<br />
		...
		<br />
		<br />
		<form name="register" action="/account/registerAndActivateNewAccount/" method="post">
