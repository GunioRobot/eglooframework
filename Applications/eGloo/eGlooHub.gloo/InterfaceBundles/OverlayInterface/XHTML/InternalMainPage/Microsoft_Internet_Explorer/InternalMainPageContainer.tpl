...
<!--{*    	<script type="text/javascript" src="/javascript/ifxPackRoot.js"></script> *}-->
    ...
    <body>
	   ...
	   <!--{include file='../Templates/Applications/eGloo/InterfaceBundles/OverlayInterface/XHTML/GlobalMenuBar/Microsoft_Internet_Explorer/GlobalMenuBarContainer.tpl'}-->
