...
<!--{*  <div id="UserProfileControlStripPictures" class="clickable">Pictures</div>
	   ...
	   <!--{include file='../Templates/Applications/eGloo/InterfaceBundles/OverlayInterface/XHTML/InternalBlogPage/ViewChildBlogComment.tpl'}-->
		...
		<div id="hiddenCollapseZone" style="position:absolute;left:0;right:0;top:0;bottom:0;display:none;background-color:transparent;width:expression(document.documentElement.clientWidth + 'px');height:expression(document.documentElement.clientHeight + 'px');">&nbsp;</div>    </body>
</html>