        ...
        <fieldset id="signup_fieldset">
            ...
            <div id="contactInformationDiv" class="licenseText">
	        	<div class="formElements">
	                ...
	                <span class="error" id="firstNameInputError">this is an error</span>
	          	</div>
	          	<div class="formElements">
	                <div class="labelcell">Last Name:</div>
	                <input id="lastNameInput" type="text" name="lastNameInput" />
	                <span class="error" id="lastNameInputError">this is an error</span>
	          	</div>
	          	<div class="formElements">
				...
				<div class="formElements">
	          	...
	          	<div class="formElements">
	                ...
	                <span class="error" id="userEmailError">this is an error</span>                    
	          	</div>
	          	<p class="end"></p>
            </div>
